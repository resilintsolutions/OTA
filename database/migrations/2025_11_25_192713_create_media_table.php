...
return new class extends Migration
{
    ...
    {
        // This project historically had two `create_media_table` migrations with
        // different schemas. The earlier one (2025_11_21_173356) may already have
        // created the table, especially on fresh local SQLite installs.
        //
        // To avoid migration failures ("table already exists"), we skip this
        // migration if `media` is already present.
